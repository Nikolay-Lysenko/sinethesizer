...
def filter_absolute_frequencies(
    ...
    nyquist_frequency = 0.5 * sound_info['frame_rate']
...
def apply_frequency_filter(
    ...
    """
    if kind == 'absolute':
        sound = filter_absolute_frequencies(sound, sound_info, *args, **kwargs)
    elif kind == 'relative':
        sound = filter_relative_frequencies(sound, sound_info, *args, **kwargs)
    else:
        raise ValueError(
