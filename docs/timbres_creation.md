...
fundamental_volume_envelope | Function that maps duration of sound event in seconds to dynamic of fundamental's volume in time; supported names of functions are 'relative_adsr', 'absolute_adsr', 'constant_with_linear_ends', and 'spike'
...
volume_envelope | Function that maps duration of sound event in seconds to dynamic of overtone's volume in time; supported names of functions are 'relative_adsr', 'absolute_adsr', 'constant_with_linear_ends', and 'spike'
effects | Effects (e.g., tremolo) that are always applied to this overtone; this field is optional
